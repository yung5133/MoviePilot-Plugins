...
from .constants import PROVIDER_KEY, PROVIDER_NAME, ROOT_CATALOG_ID
from ..common import (
...
class Yun139FileService(CloudDriveFileServiceBase):
    # 驱动标识与根标识均单点定义在 constants.py，此处仅引用。
    provider_name = PROVIDER_NAME
    provider_key = PROVIDER_KEY
    # 根标识单点定义在 constants.py，此处仅引用，避免与 client 侧不同步。
    root_directory_id = ROOT_CATALOG_ID
